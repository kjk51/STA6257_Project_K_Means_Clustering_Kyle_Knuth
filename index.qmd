...
-   Picking variables of interest
    ...
    -   Two more dataframes are created utilizing Recursive Feature
        Elimination, the first is from the original dataset and the
        second is from our variables of interest
