...
In this first chart it is shown that cluster 3 had the highest number of
car crash fatalities related to alcohol while cluster 2 had the lowest
amount. Cluster 4 had the second highest while clusters 1, 5, and 6 all
had similar amounts.
...
ggplot(data, aes(x = y, y = x)) +
  ...
  labs(title = "Afatal", x = "Cluster", y = "Value")

```

In this next chart, cluster 5 had the highest number of alcohol consumed
while clusters 1 and 3 had the lowest number. The second highest was
cluster 2.
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Spirits", x = "Cluster", y = "Value")
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Baptist", x = "Cluster", y = "Value")
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Mormon", x = "Cluster", y = "Value")
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Fatal1517", x = "Cluster", y = "Value")
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Fatal1820", x = "Cluster", y = "Value")
...
ggplot(data, aes(x = y, y = x)) +
  geom_bar(stat = "identity", fill = y) + 
  labs(title = "Fatal2124", x = "Cluster", y = "Value")

```

applying clusters to full dataset to make inferences

```{r}
subset_df <- df1[rownames(df1) %in% rownames(cleaned_df_2), ]
subset_df$cluster=km$cluster
```
